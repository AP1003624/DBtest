...
//				System.out.println(dataPoint1.getDataPointID()+" "+dataPoint1.getClusterID());
	...
	public double getKDistanceMean(DataPoint dataPoint) {
		double sum = 0.0;
		for (DataPoint kDataPoint : dataPoint.getkNN()) {
			sum += kDataPoint.getK_distance();
		}
		return sum/dataPoint.getkNN().size();
	}
